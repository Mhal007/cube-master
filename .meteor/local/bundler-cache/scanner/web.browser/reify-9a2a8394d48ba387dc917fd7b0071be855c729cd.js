module.export({default:()=>Checkbox});let _extends;module.link("@babel/runtime/helpers/extends",{default(v){_extends=v}},0);let _slicedToArray;module.link("@babel/runtime/helpers/slicedToArray",{default(v){_slicedToArray=v}},1);let _objectSpread;module.link("@babel/runtime/helpers/objectSpread",{default(v){_objectSpread=v}},2);let _classCallCheck;module.link("@babel/runtime/helpers/classCallCheck",{default(v){_classCallCheck=v}},3);let _createClass;module.link("@babel/runtime/helpers/createClass",{default(v){_createClass=v}},4);let _possibleConstructorReturn;module.link("@babel/runtime/helpers/possibleConstructorReturn",{default(v){_possibleConstructorReturn=v}},5);let _getPrototypeOf;module.link("@babel/runtime/helpers/getPrototypeOf",{default(v){_getPrototypeOf=v}},6);let _assertThisInitialized;module.link("@babel/runtime/helpers/assertThisInitialized",{default(v){_assertThisInitialized=v}},7);let _inherits;module.link("@babel/runtime/helpers/inherits",{default(v){_inherits=v}},8);let _defineProperty;module.link("@babel/runtime/helpers/defineProperty",{default(v){_defineProperty=v}},9);let _set;module.link("lodash/set",{default(v){_set=v}},10);let _invoke;module.link("lodash/invoke",{default(v){_invoke=v}},11);let _get;module.link("lodash/get",{default(v){_get=v}},12);let _isNil;module.link("lodash/isNil",{default(v){_isNil=v}},13);let Ref;module.link('@stardust-ui/react-component-ref',{Ref(v){Ref=v}},14);let cx;module.link('classnames',{default(v){cx=v}},15);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},16);let React,createRef;module.link('react',{default(v){React=v},createRef(v){createRef=v}},17);let Component,createHTMLLabel,customPropTypes,getElementType,getUnhandledProps,htmlInputAttrs,partitionHTMLProps,useKeyOnly;module.link('../../lib',{AutoControlledComponent(v){Component=v},createHTMLLabel(v){createHTMLLabel=v},customPropTypes(v){customPropTypes=v},getElementType(v){getElementType=v},getUnhandledProps(v){getUnhandledProps=v},htmlInputAttrs(v){htmlInputAttrs=v},partitionHTMLProps(v){partitionHTMLProps=v},useKeyOnly(v){useKeyOnly=v}},18);
