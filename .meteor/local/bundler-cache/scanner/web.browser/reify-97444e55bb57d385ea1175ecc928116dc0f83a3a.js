module.export({useKeyOnly:()=>useKeyOnly,useValueAndKey:()=>useValueAndKey,useKeyOrValueAndKey:()=>useKeyOrValueAndKey,useMultipleProp:()=>useMultipleProp,useTextAlignProp:()=>useTextAlignProp,useVerticalAlignProp:()=>useVerticalAlignProp,useWidthProp:()=>useWidthProp});let _typeof;module.link("@babel/runtime/helpers/typeof",{default(v){_typeof=v}},0);let numberToWord;module.link('./numberToWord',{numberToWord(v){numberToWord=v}},1);
