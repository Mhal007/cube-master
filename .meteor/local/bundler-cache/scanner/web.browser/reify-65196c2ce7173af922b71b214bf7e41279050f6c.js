module.export({default:()=>createSlider});let _objectWithoutProperties;module.link('babel-runtime/helpers/objectWithoutProperties',{default(v){_objectWithoutProperties=v}},0);let _extends;module.link('babel-runtime/helpers/extends',{default(v){_extends=v}},1);let _defineProperty;module.link('babel-runtime/helpers/defineProperty',{default(v){_defineProperty=v}},2);let _classCallCheck;module.link('babel-runtime/helpers/classCallCheck',{default(v){_classCallCheck=v}},3);let _createClass;module.link('babel-runtime/helpers/createClass',{default(v){_createClass=v}},4);let _possibleConstructorReturn;module.link('babel-runtime/helpers/possibleConstructorReturn',{default(v){_possibleConstructorReturn=v}},5);let _get;module.link('babel-runtime/helpers/get',{default(v){_get=v}},6);let _inherits;module.link('babel-runtime/helpers/inherits',{default(v){_inherits=v}},7);let React;module.link('react',{default(v){React=v}},8);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},9);let addEventListener;module.link('rc-util/es/Dom/addEventListener',{default(v){addEventListener=v}},10);let classNames;module.link('classnames',{default(v){classNames=v}},11);let warning;module.link('warning',{default(v){warning=v}},12);let Steps;module.link('./Steps',{default(v){Steps=v}},13);let Marks;module.link('./Marks',{default(v){Marks=v}},14);let Handle;module.link('../Handle',{default(v){Handle=v}},15);let utils;module.link('../utils',{"*"(v){utils=v}},16);
