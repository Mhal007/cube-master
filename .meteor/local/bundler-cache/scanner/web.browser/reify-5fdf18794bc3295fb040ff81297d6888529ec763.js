module.export({getAutoControlledStateValue:()=>getAutoControlledStateValue,default:()=>AutoControlledComponent});let _objectSpread;module.link("@babel/runtime/helpers/objectSpread",{default(v){_objectSpread=v}},0);let _classCallCheck;module.link("@babel/runtime/helpers/classCallCheck",{default(v){_classCallCheck=v}},1);let _createClass;module.link("@babel/runtime/helpers/createClass",{default(v){_createClass=v}},2);let _possibleConstructorReturn;module.link("@babel/runtime/helpers/possibleConstructorReturn",{default(v){_possibleConstructorReturn=v}},3);let _getPrototypeOf;module.link("@babel/runtime/helpers/getPrototypeOf",{default(v){_getPrototypeOf=v}},4);let _assertThisInitialized;module.link("@babel/runtime/helpers/assertThisInitialized",{default(v){_assertThisInitialized=v}},5);let _inherits;module.link("@babel/runtime/helpers/inherits",{default(v){_inherits=v}},6);let _defineProperty;module.link("@babel/runtime/helpers/defineProperty",{default(v){_defineProperty=v}},7);let _isUndefined;module.link("lodash/isUndefined",{default(v){_isUndefined=v}},8);let _startsWith;module.link("lodash/startsWith",{default(v){_startsWith=v}},9);let _filter;module.link("lodash/filter",{default(v){_filter=v}},10);let _isEmpty;module.link("lodash/isEmpty",{default(v){_isEmpty=v}},11);let _keys;module.link("lodash/keys",{default(v){_keys=v}},12);let _intersection;module.link("lodash/intersection",{default(v){_intersection=v}},13);let _has;module.link("lodash/has",{default(v){_has=v}},14);let _each;module.link("lodash/each",{default(v){_each=v}},15);let _invoke;module.link("lodash/invoke",{default(v){_invoke=v}},16);let Component;module.link('react',{Component(v){Component=v}},17);
