let _inRange;module.link("lodash/inRange",{default(v){_inRange=v}},0);let _first;module.link("lodash/first",{default(v){_first=v}},1);let _invoke;module.link("lodash/invoke",{default(v){_invoke=v}},2);let _isNil;module.link("lodash/isNil",{default(v){_isNil=v}},3);let _some;module.link("lodash/some",{default(v){_some=v}},4);
