let _defineProperty;module.link('babel-runtime/helpers/defineProperty',{default(v){_defineProperty=v}},0);let _extends;module.link('babel-runtime/helpers/extends',{default(v){_extends=v}},1);let _toConsumableArray;module.link('babel-runtime/helpers/toConsumableArray',{default(v){_toConsumableArray=v}},2);let _classCallCheck;module.link('babel-runtime/helpers/classCallCheck',{default(v){_classCallCheck=v}},3);let _createClass;module.link('babel-runtime/helpers/createClass',{default(v){_createClass=v}},4);let _possibleConstructorReturn;module.link('babel-runtime/helpers/possibleConstructorReturn',{default(v){_possibleConstructorReturn=v}},5);let _inherits;module.link('babel-runtime/helpers/inherits',{default(v){_inherits=v}},6);let React;module.link('react',{default(v){React=v}},7);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},8);let classNames;module.link('classnames',{default(v){classNames=v}},9);let polyfill;module.link('react-lifecycles-compat',{polyfill(v){polyfill=v}},10);let shallowEqual;module.link('shallowequal',{default(v){shallowEqual=v}},11);let Track;module.link('./common/Track',{default(v){Track=v}},12);let createSlider;module.link('./common/createSlider',{default(v){createSlider=v}},13);let utils;module.link('./utils',{"*"(v){utils=v}},14);
...
module.exportDefault(createSlider(Range));