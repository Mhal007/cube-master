let React,Component;module.link('react',{default(v){React=v},Component(v){Component=v}},0);let moment;module.link('moment',{default(v){moment=v}},1);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},2);let Grid,Menu;module.link('semantic-ui-react',{Grid(v){Grid=v},Menu(v){Menu=v}},3);let SemanticToastContainer,toast;module.link('react-semantic-toasts',{SemanticToastContainer(v){SemanticToastContainer=v},toast(v){toast=v}},4);let AlgSettings;module.link('../algSettings',{default(v){AlgSettings=v}},5);let Averages;module.link('../averages',{default(v){Averages=v}},6);let TipsAndTricks;module.link('../tipsAndTricks',{default(v){TipsAndTricks=v}},7);let TrainingMain;module.link('../trainingMain',{default(v){TrainingMain=v}},8);let getRandomScramble;module.link('/lib/global-helpers',{getRandomScramble(v){getRandomScramble=v}},9);
