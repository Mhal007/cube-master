let _extends;module.link('babel-runtime/helpers/extends',{default(v){_extends=v}},0);let _classCallCheck;module.link('babel-runtime/helpers/classCallCheck',{default(v){_classCallCheck=v}},1);let _possibleConstructorReturn;module.link('babel-runtime/helpers/possibleConstructorReturn',{default(v){_possibleConstructorReturn=v}},2);let _inherits;module.link('babel-runtime/helpers/inherits',{default(v){_inherits=v}},3);let React;module.link('react',{default(v){React=v}},4);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},5);let findDOMNode,createPortal;module.link('react-dom',{findDOMNode(v){findDOMNode=v},createPortal(v){createPortal=v}},6);let polyfill;module.link('react-lifecycles-compat',{polyfill(v){polyfill=v}},7);let contains;module.link('rc-util/es/Dom/contains',{default(v){contains=v}},8);let addEventListener;module.link('rc-util/es/Dom/addEventListener',{default(v){addEventListener=v}},9);let ContainerRender;module.link('rc-util/es/ContainerRender',{default(v){ContainerRender=v}},10);let Portal;module.link('rc-util/es/Portal',{default(v){Portal=v}},11);let classNames;module.link('classnames',{default(v){classNames=v}},12);let getAlignFromPlacement,getAlignPopupClassName;module.link('./utils',{getAlignFromPlacement(v){getAlignFromPlacement=v},getAlignPopupClassName(v){getAlignPopupClassName=v}},13);let Popup;module.link('./Popup',{default(v){Popup=v}},14);
