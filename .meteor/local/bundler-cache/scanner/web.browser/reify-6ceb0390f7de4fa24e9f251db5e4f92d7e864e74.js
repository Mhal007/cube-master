module.export({canFit:()=>canFit,getLegacyStyles:()=>getLegacyStyles,isLegacy:()=>isLegacy});// https://github.com/Semantic-Org/Semantic-UI/blob/2.4.1/src/definitions/modules/modal.js#L956
