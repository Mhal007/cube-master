let _extends;module.link('babel-runtime/helpers/extends',{default(v){_extends=v}},0);let _defineProperty;module.link('babel-runtime/helpers/defineProperty',{default(v){_defineProperty=v}},1);let React;module.link('react',{default(v){React=v}},2);
