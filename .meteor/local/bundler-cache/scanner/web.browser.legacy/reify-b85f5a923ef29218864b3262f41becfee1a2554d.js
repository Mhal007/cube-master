var _extends;module.link('babel-runtime/helpers/extends',{default:function(v){_extends=v}},0);var _classCallCheck;module.link('babel-runtime/helpers/classCallCheck',{default:function(v){_classCallCheck=v}},1);var _possibleConstructorReturn;module.link('babel-runtime/helpers/possibleConstructorReturn',{default:function(v){_possibleConstructorReturn=v}},2);var _inherits;module.link('babel-runtime/helpers/inherits',{default:function(v){_inherits=v}},3);var React;module.link('react',{default:function(v){React=v}},4);var PropTypes;module.link('prop-types',{default:function(v){PropTypes=v}},5);var findDOMNode,createPortal;module.link('react-dom',{findDOMNode:function(v){findDOMNode=v},createPortal:function(v){createPortal=v}},6);var polyfill;module.link('react-lifecycles-compat',{polyfill:function(v){polyfill=v}},7);var contains;module.link('rc-util/es/Dom/contains',{default:function(v){contains=v}},8);var addEventListener;module.link('rc-util/es/Dom/addEventListener',{default:function(v){addEventListener=v}},9);var ContainerRender;module.link('rc-util/es/ContainerRender',{default:function(v){ContainerRender=v}},10);var Portal;module.link('rc-util/es/Portal',{default:function(v){Portal=v}},11);var classNames;module.link('classnames',{default:function(v){classNames=v}},12);var getAlignFromPlacement,getAlignPopupClassName;module.link('./utils',{getAlignFromPlacement:function(v){getAlignFromPlacement=v},getAlignPopupClassName:function(v){getAlignPopupClassName=v}},13);var Popup;module.link('./Popup',{default:function(v){Popup=v}},14);
