module.export({default:function(){return createSlider}});var _objectWithoutProperties;module.link('babel-runtime/helpers/objectWithoutProperties',{default:function(v){_objectWithoutProperties=v}},0);var _extends;module.link('babel-runtime/helpers/extends',{default:function(v){_extends=v}},1);var _defineProperty;module.link('babel-runtime/helpers/defineProperty',{default:function(v){_defineProperty=v}},2);var _classCallCheck;module.link('babel-runtime/helpers/classCallCheck',{default:function(v){_classCallCheck=v}},3);var _createClass;module.link('babel-runtime/helpers/createClass',{default:function(v){_createClass=v}},4);var _possibleConstructorReturn;module.link('babel-runtime/helpers/possibleConstructorReturn',{default:function(v){_possibleConstructorReturn=v}},5);var _get;module.link('babel-runtime/helpers/get',{default:function(v){_get=v}},6);var _inherits;module.link('babel-runtime/helpers/inherits',{default:function(v){_inherits=v}},7);var React;module.link('react',{default:function(v){React=v}},8);var PropTypes;module.link('prop-types',{default:function(v){PropTypes=v}},9);var addEventListener;module.link('rc-util/es/Dom/addEventListener',{default:function(v){addEventListener=v}},10);var classNames;module.link('classnames',{default:function(v){classNames=v}},11);var warning;module.link('warning',{default:function(v){warning=v}},12);var Steps;module.link('./Steps',{default:function(v){Steps=v}},13);var Marks;module.link('./Marks',{default:function(v){Marks=v}},14);var Handle;module.link('../Handle',{default:function(v){Handle=v}},15);var utils;module.link('../utils',{"*":function(v){utils=v}},16);
