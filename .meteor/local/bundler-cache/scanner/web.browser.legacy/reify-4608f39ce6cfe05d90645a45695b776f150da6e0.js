module.export({createShorthand:function(){return createShorthand},createShorthandFactory:function(){return createShorthandFactory},createHTMLDivision:function(){return createHTMLDivision},createHTMLIframe:function(){return createHTMLIframe},createHTMLImage:function(){return createHTMLImage},createHTMLInput:function(){return createHTMLInput},createHTMLLabel:function(){return createHTMLLabel},createHTMLParagraph:function(){return createHTMLParagraph}});var _objectSpread;module.link("@babel/runtime/helpers/objectSpread",{default:function(v){_objectSpread=v}},0);var _typeof;module.link("@babel/runtime/helpers/typeof",{default:function(v){_typeof=v}},1);var _uniq;module.link("lodash/uniq",{default:function(v){_uniq=v}},2);var _isArray;module.link("lodash/isArray",{default:function(v){_isArray=v}},3);var _isPlainObject;module.link("lodash/isPlainObject",{default:function(v){_isPlainObject=v}},4);var _isFunction;module.link("lodash/isFunction",{default:function(v){_isFunction=v}},5);var _isNumber;module.link("lodash/isNumber",{default:function(v){_isNumber=v}},6);var _isString;module.link("lodash/isString",{default:function(v){_isString=v}},7);var _isBoolean;module.link("lodash/isBoolean",{default:function(v){_isBoolean=v}},8);var _isNil;module.link("lodash/isNil",{default:function(v){_isNil=v}},9);var cx;module.link('classnames',{default:function(v){cx=v}},10);var React,cloneElement,isValidElement;module.link('react',{default:function(v){React=v},cloneElement:function(v){cloneElement=v},isValidElement:function(v){isValidElement=v}},11);
