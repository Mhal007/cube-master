module.export({default:function(){return Checkbox}});var _extends;module.link("@babel/runtime/helpers/extends",{default:function(v){_extends=v}},0);var _slicedToArray;module.link("@babel/runtime/helpers/slicedToArray",{default:function(v){_slicedToArray=v}},1);var _objectSpread;module.link("@babel/runtime/helpers/objectSpread",{default:function(v){_objectSpread=v}},2);var _classCallCheck;module.link("@babel/runtime/helpers/classCallCheck",{default:function(v){_classCallCheck=v}},3);var _createClass;module.link("@babel/runtime/helpers/createClass",{default:function(v){_createClass=v}},4);var _possibleConstructorReturn;module.link("@babel/runtime/helpers/possibleConstructorReturn",{default:function(v){_possibleConstructorReturn=v}},5);var _getPrototypeOf;module.link("@babel/runtime/helpers/getPrototypeOf",{default:function(v){_getPrototypeOf=v}},6);var _assertThisInitialized;module.link("@babel/runtime/helpers/assertThisInitialized",{default:function(v){_assertThisInitialized=v}},7);var _inherits;module.link("@babel/runtime/helpers/inherits",{default:function(v){_inherits=v}},8);var _defineProperty;module.link("@babel/runtime/helpers/defineProperty",{default:function(v){_defineProperty=v}},9);var _set;module.link("lodash/set",{default:function(v){_set=v}},10);var _invoke;module.link("lodash/invoke",{default:function(v){_invoke=v}},11);var _get;module.link("lodash/get",{default:function(v){_get=v}},12);var _isNil;module.link("lodash/isNil",{default:function(v){_isNil=v}},13);var Ref;module.link('@stardust-ui/react-component-ref',{Ref:function(v){Ref=v}},14);var cx;module.link('classnames',{default:function(v){cx=v}},15);var PropTypes;module.link('prop-types',{default:function(v){PropTypes=v}},16);var React,createRef;module.link('react',{default:function(v){React=v},createRef:function(v){createRef=v}},17);var Component,createHTMLLabel,customPropTypes,getElementType,getUnhandledProps,htmlInputAttrs,partitionHTMLProps,useKeyOnly;module.link('../../lib',{AutoControlledComponent:function(v){Component=v},createHTMLLabel:function(v){createHTMLLabel=v},customPropTypes:function(v){customPropTypes=v},getElementType:function(v){getElementType=v},getUnhandledProps:function(v){getUnhandledProps=v},htmlInputAttrs:function(v){htmlInputAttrs=v},partitionHTMLProps:function(v){partitionHTMLProps=v},useKeyOnly:function(v){useKeyOnly=v}},18);
